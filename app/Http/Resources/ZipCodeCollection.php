...
class ZipCodeCollection extends ResourceCollection
{
     ...
     * @return array
     */
    #[ArrayShape(['zip_code' => "mixed", 'locality' => "array|string|string[]", 'federal_entity' => "array", 'settlements' => "mixed", 'municipality' => "array"])] public function toArray($request): array
    {
    ...
    protected function replaceAccents($str): array|string
    {
